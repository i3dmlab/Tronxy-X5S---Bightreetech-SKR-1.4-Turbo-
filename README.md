# Tronxy-X5S---Bightreetech-SKR-1.4-Turbo-
In this repo you find the configuratio.h, configuration_adv.h and platformio.ini files to use to code the Marlin firmware for a Tronxy X5S with a Bigtreetech SKR 1.4 Turbo board
