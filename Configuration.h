...
#define STRING_CONFIG_H_AUTHOR "(I3D&MLAB)" // Original author or contributor.
...
#define BAUDRATE 115200   // :[2400, 9600, 19200, 38400, 57600, 115200, 250000, 500000, 1000000] Enable to override BAUDRATE
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_KP_LIST {  51.00,  51.00 }
    #define DEFAULT_KI_LIST {   9.63,   9.63 }
    #define DEFAULT_KD_LIST {  67.51,  67.51 }
  #else
    #define DEFAULT_KP  51.00
...
//
//#define BIGTREE_TFT35_E3_V3_0_1
//
